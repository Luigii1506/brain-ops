...
CANONICAL_PREDICATES: dict[str, str] = {
    ...
    # Religion structural — Campaña 2 (religion-domain governance)
    "founded_by": "tradition, religion, school, or institution founded by a person",
    "founder_of": "person who founded a tradition, religion, school, or institution",
    "uses_text": "tradition that holds a text as canonical or scriptural",
    "text_of": "text canonical to a tradition (inverse of uses_text)",
    "has_branch": "parent tradition that contains a branch or denomination",
    "branch_of": "branch or denomination of a parent tradition",
    "celebrates": "tradition or community that celebrates a festival or observance",
    "celebrated_by": "festival or observance celebrated by a tradition or community",
    "practiced_in": "practice or rite practiced within a tradition or region",
    "related_concept": "conceptually adjacent or sibling concept within a domain",
    "contrasts_with": "structural opposition or polar pair (e.g. cielo/infierno)",
    "emerged_in": "religious or cultural emergence within a tradition or context",
...
PREDICATE_NORMALIZATION: dict[str, str] = {
    ...
    # Campaña 2 — religion-domain aliases
    "founded by": "founded_by",
    "fundado por": "founded_by",
    "fundada por": "founded_by",
    "founder of": "founder_of",
    "fundador de": "founder_of",
    "fundadora de": "founder_of",
    "uses text": "uses_text",
    "usa el texto": "uses_text",
    "utiliza el texto": "uses_text",
    "text of": "text_of",
    "texto de": "text_of",
    "has branch": "has_branch",
    "tiene rama": "has_branch",
    "branch of": "branch_of",
    "rama de": "branch_of",
    "celebrates": "celebrates",
    "celebra": "celebrates",
    "celebrated by": "celebrated_by",
    "celebrado por": "celebrated_by",
    "celebrada por": "celebrated_by",
    "practiced in": "practiced_in",
    "practicado en": "practiced_in",
    "practicada en": "practiced_in",
    "related concept": "related_concept",
    "concepto relacionado": "related_concept",
    "contrasts with": "contrasts_with",
    "contrasta con": "contrasts_with",
    "se contrapone a": "contrasts_with",
    "emerged in": "emerged_in",
    "emergió en": "emerged_in",
    "surgió en": "emerged_in",
}
