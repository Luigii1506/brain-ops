...
def capture_text(
    ...
    inferred_type, reason = infer_capture_type(raw_text, force_type)
    resolved_title = title or infer_capture_title(raw_text, inferred_type)
    body = build_capture_body(raw_text, inferred_type)
    extra_frontmatter = build_capture_frontmatter(raw_text, inferred_type)
