...
class PublicExportSurfacesTestCase(TestCase):
    def test_application_exports_reuse_workflow_modules(self) -> None:
        ...
        self.assertIs(application.execute_compile_knowledge_workflow, app_knowledge.execute_compile_knowledge_workflow)
        ...
        from brain_ops.application import projects as app_projects
        self.assertIs(application.execute_register_project_workflow, app_projects.execute_register_project_workflow)
        self.assertIs(application.execute_list_projects_workflow, app_projects.execute_list_projects_workflow)
        self.assertIs(application.execute_project_context_workflow, app_projects.execute_project_context_workflow)
        from brain_ops.application import sources as app_sources
        self.assertIs(application.execute_add_source_workflow, app_sources.execute_add_source_workflow)
        self.assertIs(application.execute_check_source_workflow, app_sources.execute_check_source_workflow)
        self.assertIs(application.execute_list_sources_workflow, app_sources.execute_list_sources_workflow)
        ...
        self.assertIn("execute_compile_knowledge_workflow", exported)
        ...
        self.assertIn("execute_register_project_workflow", exported)
        self.assertIn("execute_list_projects_workflow", exported)
        self.assertIn("execute_project_context_workflow", exported)
        self.assertIn("execute_add_source_workflow", exported)
        self.assertIn("execute_check_source_workflow", exported)
        self.assertIn("execute_list_sources_workflow", exported)
    ...
    def test_cli_exports_reuse_specialized_adapter_modules(self) -> None:
        ...
        self.assertIs(cli.present_compile_knowledge_command, cli_knowledge.present_compile_knowledge_command)
        ...
        from brain_ops.interfaces.cli import projects as cli_projects
        self.assertIs(cli.present_register_project_command, cli_projects.present_register_project_command)
        self.assertIs(cli.present_list_projects_command, cli_projects.present_list_projects_command)
        self.assertIs(cli.present_project_context_command, cli_projects.present_project_context_command)
        from brain_ops.interfaces.cli import sources as cli_sources
        self.assertIs(cli.present_add_source_command, cli_sources.present_add_source_command)
        self.assertIs(cli.present_check_source_command, cli_sources.present_check_source_command)
        self.assertIs(cli.present_list_sources_command, cli_sources.present_list_sources_command)
        ...
        self.assertIn("present_compile_knowledge_command", exported)
        ...
        self.assertIn("present_register_project_command", exported)
        self.assertIn("present_list_projects_command", exported)
        self.assertIn("present_project_context_command", exported)
        self.assertIn("present_add_source_command", exported)
        self.assertIn("present_check_source_command", exported)
        self.assertIn("present_list_sources_command", exported)
